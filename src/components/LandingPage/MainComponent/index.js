...
function MainComponent(){
    return <div className="flex-info">
        <div className="left-component">
            ...
            <motion.p className="info-text" initial={{opacity:0, x:50}} animate={{opacity:1, x: 0}} transition={{duration:0.5, delay: 1}}>
                Track crypto through a public api in real life. Visit the dashboard to do so!
            </motion.p>
